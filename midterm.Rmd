...
#training data
x = model.matrix(log_PFS ~ ., training_datA)[, -1]
y = training_datA$log_PFS

#test data
x2 = model.matrix(log_PFS ~ ., testing_datA)[, -1]
y2 = testing_datA$log_PFS
...
#training data
x = model.matrix(log_PFS ~ ., training_datB)[, -1]
y = training_datB$log_PFS

#test data
x2 = model.matrix(log_PFS ~ ., testing_datB)[, -1]
y2 = testing_datB$log_PFS
